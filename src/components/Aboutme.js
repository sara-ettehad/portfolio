...
const Aboutme = () => {
    return (
        <section className="about-me">
            <h1>About Me</h1>
            <p>Hello! I'm a passionate Front-End Developer with a love for React and UI/UX design. I enjoy creating user-friendly and visually appealing websites and applications. In my free time, I love exploring new technologies, reading about design trends, and contributing to open-source projects.</p>
